...
const Index = () => (
  <Switch>
    ...
    <Route
      path="/articles"
      render={props => (
        <TemplateSidebar pageTitle="Articles">
          <ArticlesContainer {...props} Layout={ArticleListingComponent} />
        </TemplateSidebar>
      )}
    />
    <Route
      path="/article/:id"
      render={props => (
        <TemplateSidebar pageTitle="Article View">
          <ArticlesContainer {...props} Layout={ArticleSingleComponent} />
        </TemplateSidebar>
      )}
    />
    <Route
